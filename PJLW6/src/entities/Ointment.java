...
public class Ointment implements Medication {
    ...
    public void conductResearch() {
        try {
            File file = new File(name + "_Ointment_research.txt");
            FileWriter fileWriter = new FileWriter(file, false);
            fileWriter.write(toString());
            fileWriter.close();
            System.out.println("\nThe results of " + name + " research are printed in file " + name + "_ointment_research.txt");
        } 
        catch (IOException e) {
